...
spark_app_name = "cc_fraud_demo_nismaily"
...
credit_card_data = spark.read.csv(
    "resources/creditcard.csv", header=True, mode="DROPMALFORMED",inferSchema=True
)
...
credit_card_dataframe_final.to_pickle("resources/credit_card_dataframe.pkl",compression="gzip")
